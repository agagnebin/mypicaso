...
def calculate_atm_deq(bundle, opacityclass,on_fly=False,gases_fly=None, fthin_cld = None, do_holes=None, custom_abundances = False, abund_name = None, abunds = None):
